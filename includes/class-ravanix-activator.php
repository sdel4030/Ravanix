...
class Ravanix_Activator {
	...
	public static function activate() {
		...
		// Questions table
		// branch_condition_question_id/branch_condition_value: simple single-condition
		// skip logic. When branch_condition_question_id is set, this question is only
		// shown if the referenced question's submitted answer equals
		// branch_condition_value; NULL (the default) means "always shown", so every
		// existing question on an upgraded site keeps behaving exactly as before.

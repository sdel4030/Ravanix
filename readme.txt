...
attempts. Ravanix Pro requires this plugin (Ravanix) to be installed
...
Ravanix (this plugin) is fully functional on its own for building and
...
source translation file is at languages/ravanix.pot, and you can use
